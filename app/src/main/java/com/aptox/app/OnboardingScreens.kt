...
private data class OnboardingPage(
    ...
    val subtitleUsesAptoxHighlight: Boolean = false,
)
...
fun OnboardingHost(
    ...
    val pages = listOf(
        ...
        OnboardingPage(
            "스마트폰, ",
            "이제 거리를 둘 때예요",
            "aptox는 당신이 과하게 소비하는 앱을",
            "효과적으로 제한해드려요",
            R.drawable.ob_04_image,
            subtitleUsesAptoxHighlight = true,
        ),
    )
    ...
    Box(
        ...
        HorizontalPager(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    if (p.subtitleUsesAptoxHighlight) {
                        Text(
        ...
        Box(
            ...
            AptoxPageIndicator(pageCount = 4, currentPage = pagerState.currentPage)
        }
