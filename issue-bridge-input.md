...
- [x] AptoxTwoLineButton으로 교체 및 콜백 시그니처 수정 (onPrimaryClick, onGhostClick)
- [x] DebugMenuScreen 호출부 수정

## 관련 파일

- `app/src/main/java/com/aptox/app/PermissionScreen.kt` - 권한 안내 화면 Composable
- `app/src/main/java/com/aptox/app/DebugMenuScreen.kt` - PermissionScreen 호출부
- `app/src/main/java/com/aptox/app/ButtonComponents.kt` - AptoxTwoLineButton 사용
- `app/src/main/java/com/aptox/app/AppColors.kt` - 해당 화면에서 사용하는 색상 스타일
- `app/src/main/java/com/aptox/app/AppTypography.kt` - 해당 화면에서 사용하는 타이포그래피
...
- 해결: AptoxTwoLineButton 적용, 콜백 onPrimaryClick/onGhostClick 분리, "①" 제거
